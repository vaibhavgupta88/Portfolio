...
export const MapCard: React.FC = () => {
  ...
  return (
    <motion.div 
      ...
      className="bg-white/80 hover:bg-white/90 dark:bg-[#181816]/85 dark:hover:bg-[#20201D]/95 backdrop-blur-2xl rounded-[28px] border border-white/70 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.03),inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.35),inset_0_1px_0_rgba(255,255,255,0.08)] hover:shadow-[0_14px_40px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,1)] dark:hover:shadow-[0_14px_40px_rgba(0,0,0,0.45),inset_0_1px_0_rgba(255,255,255,0.12)] flex flex-col h-full min-h-[340px] relative overflow-hidden group transition-all duration-300 select-none cursor-default"
    >
      ...
      {/* Top Map Section (Real Draggable Leaflet Map filling available space) */}
      <div className="relative w-full flex-1 min-h-[220px] overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-white via-white/90 to-transparent dark:from-[#181816] dark:via-[#181816]/90 z-10 pointer-events-none" />
      </div>

      {/* Bottom Architectural Typography matching reference image */}
      <div className="relative z-20 w-full flex flex-col items-center justify-center pb-6 pt-2 text-center bg-white/95 dark:bg-[#181816]/95 backdrop-blur-md">
