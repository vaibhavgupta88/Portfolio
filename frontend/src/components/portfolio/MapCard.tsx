...
export const MapCard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center pb-6 pt-1 text-center bg-white/90 backdrop-blur-md">
        <h3 className="text-xl sm:text-[22px] font-bold text-[#111111] tracking-[0.35em] uppercase pl-[0.35em] leading-tight">
          NOIDA
        </h3>
        
        <p className="text-[10px] sm:text-[11px] font-medium text-[#787873] tracking-[0.38em] uppercase pl-[0.38em] mt-1">
          INDIA
        </p>
        
        <p className="text-[9px] font-mono text-[#A8A8A2] tracking-[0.18em] uppercase pl-[0.18em] mt-1.5">
          28.5355° N, 77.3910° E
        </p>
      </div>
    </motion.div>
