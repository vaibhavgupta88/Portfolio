    ...
    >
      ...
      <div className="my-auto space-y-3.5">
        <div>
          ...
          <p className="text-[11.5px] font-medium text-[#555550] mt-0.5">
            Cumulative GPA: <span className="font-bold text-[#111111]">7.91</span> / 10.0
          </p>
        </div>

        {/* Bulleted Relevant Coursework Section */}
        <div className="pt-2.5 border-t border-neutral-200/50">
          <span className="text-[10px] font-bold text-[#8A8A85] uppercase tracking-wider block mb-2">
            Core Coursework
          </span>
          <ul className="space-y-1.5 text-[11.5px] text-[#444440]">
