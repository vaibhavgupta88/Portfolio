            ...
            >
              ...
              >
                <div className="bg-white/85 hover:bg-white/95 dark:bg-[#181816]/85 dark:hover:bg-[#20201D]/95 backdrop-blur-2xl rounded-[24px] sm:rounded-[28px] border border-white/90 dark:border-white/10 shadow-[0_12px_36px_rgba(0,0,0,0.04),inset_0_1px_0_rgba(255,255,255,0.95)] dark:shadow-[0_12px_36px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.08)] hover:shadow-[0_20px_48px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_20px_48px_rgba(0,0,0,0.5)] transition-all duration-300 overflow-hidden group">
                  ...
                  <div className="relative aspect-[16/11] sm:aspect-[16/11.5] w-full bg-[#FAFAF8] dark:bg-[#0E0E0D] overflow-hidden">
                    {/* Live Embedded Interactive Iframe with smooth native zoom scaling */}
                    <div className="w-full h-full relative group/frame overflow-hidden">
                      <iframe
                        src={project.liveUrl}
                        title={`${project.title} Preview`}
                        style={{ zoom: 0.68 }}
                        className="w-[calc(100%+14px)] h-full border-0 bg-transparent pointer-events-auto transition-opacity select-none"
                        loading="lazy"
                        sandbox="allow-scripts allow-same-origin allow-forms allow-popups"
                      />

                      {/* Glassmorphic Hover Overlay with direct Launch CTA */}
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent opacity-0 group-hover/frame:opacity-100 transition-opacity duration-200 flex items-end justify-between p-4 pointer-events-none">
