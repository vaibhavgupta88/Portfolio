...
export const ProjectShowcaseSection: React.FC = () => {
  return (
    <section id="projects" className="px-2 sm:px-4 max-w-5xl mx-auto w-full pt-16 pb-12">
      {/* Section Header */}
      <div className="mb-14 pb-5 border-b border-[#E8E8E4]/70 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-2">
            <span className="w-2 h-2 rounded-full bg-[#FF5A1F] animate-pulse" />
            <h3 className="text-xs font-bold text-[#8A8A85] uppercase tracking-[0.2em]">
        ...
        <p className="text-sm text-[#7A7A75] max-w-md">
        ...
        {showcaseProjects.map((project, idx) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="bg-white/85 hover:bg-white/95 backdrop-blur-2xl rounded-[24px] sm:rounded-[28px] border border-white/90 shadow-[0_12px_36px_rgba(0,0,0,0.04),inset_0_1px_0_rgba(255,255,255,0.95)] hover:shadow-[0_20px_48px_rgba(0,0,0,0.08)] transition-all duration-300 overflow-hidden group">
                  {/* macOS Window Header Chrome */}
                  <div className="bg-[#F4F4F1] border-b border-[#EAEAE6] px-4 py-3 flex items-center justify-between select-none">
                    {/* Traffic Lights */}
                    ...
                    {/* Address Bar */}
                    <div className="flex items-center gap-1.5 bg-white px-3 py-1 rounded-full border border-[#E2E2DD] text-[11px] font-mono text-[#555550] shadow-2xs max-w-[200px] sm:max-w-xs truncate">
                    ...
                    <a
                      ...
                      className="p-1 rounded-md text-[#787873] hover:text-[#111111] hover:bg-white/60 transition-colors"
                      title="Open Live URL"
                    >
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="font-mono text-xs font-bold text-[#FF5A1F] tracking-wider px-2 py-0.5 rounded-md bg-[#FF5A1F]/10 border border-[#FF5A1F]/20">
                    {project.index}
                  </span>
                  <span className="text-xs font-semibold text-[#8A8A85] uppercase tracking-wider">
                    {project.kicker}
                  </span>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="inline-block text-[11px] font-semibold text-[#666660] bg-[#ECECE8] px-2.5 py-0.5 rounded-full">
                      {project.badge}
                    </span>
                  </div>
                </div>
                ...
                <div className="space-y-2 pt-1">
                  {project.bullets.map((bullet, bIdx) => (
                    <div key={bIdx} className="flex items-start gap-2.5 text-xs text-[#555550] leading-normal">
                ...
                {/* Technologies List */}
                <div className="pt-2">
                  <p className="text-[10.5px] uppercase font-bold text-[#8A8A85] tracking-wider mb-2">
                    Core Technologies
                  </p>
                  <div className="flex flex-wrap gap-1.5">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="px-2.5 py-0.5 rounded-full bg-white text-[11px] font-medium text-[#444440] border border-[#E4E4DE] shadow-2xs"
                      >
                        {t}
                      </span>
                    ))}
                ...
                <div className="flex items-center gap-3 pt-4">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#111111] text-white text-xs font-semibold hover:bg-[#FF5A1F] transition-colors shadow-sm"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-white text-[#333330] hover:text-[#111111] text-xs font-semibold border border-[#DEDEDA] hover:border-[#111111] transition-colors shadow-2xs"
                  >
